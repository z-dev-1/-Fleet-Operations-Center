...
expose('slack', {
  ...
  fasSnoozeFollowup:      (data)   => ipcRenderer.invoke('fas:snooze-followup', data),
  fasCompleteFollowup:    (data)   => ipcRenderer.invoke('fas:complete-followup', data),
  fasDismissFollowup:     (caseId) => ipcRenderer.invoke('fas:dismiss-followup', caseId),
  fasGetActionCatalog:    ()       => ipcRenderer.invoke('fas:get-action-catalog'),
  fasGetCoverage:         ()       => ipcRenderer.invoke('fas:get-coverage'),
  fasRefreshCoverage:     ()       => ipcRenderer.invoke('fas:refresh-coverage'),
  fasGetEngineStatus:     ()       => ipcRenderer.invoke('fas:get-engine-status'),
