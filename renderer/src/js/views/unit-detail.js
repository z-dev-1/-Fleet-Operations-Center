...
function renderRepairPane(unit){
  ...
  if (aiTimeline && aiTimeline.length > 20) {
    ...
    timelineHtml =
      ...
      '<div id="dp-tl-input-row" class="dp-tl-input-row" style="display:none"><input id="dp-tl-input" class="dp-tl-input" type="text" placeholder="Type update... (AI will professionalize)"/><button id="dp-tl-submit" class="dp-tl-submit-btn">Add</button></div>' +
  ...
  setTimeout(function() {
    ...
    function doAdd() {
      ...
      // Save immediately (truth - user typed it)
      ...
      var tlEl = document.querySelector('.dp-orcha-timeline');
      if (tlEl) {
        tlEl.innerHTML += '<div class="dp-tl3-item dp-tl3-dot--ai" style="border-left-color:#f0a800"><span class="dp-tl3-date">' + dateStr + '</span><span class="dp-tl3-dash"> \u2014 </span><span class="dp-tl3-text">' + raw + '</span></div>';
      }
