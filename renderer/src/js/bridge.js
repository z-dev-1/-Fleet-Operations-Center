...
export const slack = {
  ...
  fasGetReplyQueue:       (status) => window.slack.fasGetReplyQueue(status),
  ...
  fasSnoozeFollowup:      (data)   => window.slack.fasSnoozeFollowup(data),
  fasCompleteFollowup:    (data)   => window.slack.fasCompleteFollowup(data),
  fasDismissFollowup:     (caseId) => window.slack.fasDismissFollowup(caseId),
