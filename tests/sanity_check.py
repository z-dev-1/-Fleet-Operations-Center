...
# S24-2: vendor:complete banner -- caseUrl deep-link + SR copy
chk('S24-2-A: _renderCompleteBanner function defined', '_renderCompleteBanner' in udt)
chk('S24-2-B: vendor:complete handler calls _renderCompleteBanner', '_renderCompleteBanner(actEl, p)' in udt)
chk('S24-2-C: banner renders dp-vnd-complete-banner wrapper', 'dp-vnd-complete-banner' in udt)
chk('S24-2-D: banner renders dp-vnd-complete-sr-num for SR number', 'dp-vnd-complete-sr-num' in udt)
chk('S24-2-E: banner has copy button with data-copy attribute', 'dp-vnd-copy-btn' in udt and 'data-copy' in udt)
chk('S24-2-F: copy button calls navigator.clipboard.writeText', 'navigator.clipboard.writeText(btn.dataset.copy)' in udt)
chk('S24-2-G: caseUrl deep-link rendered as dp-vnd-complete-link anchor', 'dp-vnd-complete-link' in udt)
chk('S24-2-H: portal link calls window.files.openExternal', 'window.files.openExternal(url)' in udt)
chk('S24-2-I: altId rendered separately when differs from caseNumber', 'altId !== sr' in udt and 'dp-vnd-complete-altid' in udt)
