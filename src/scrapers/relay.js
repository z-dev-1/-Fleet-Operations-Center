...
// Open (non-terminal) AAP work-request statuses — used to filter server-side so closed/completed
    ...
    win.webContents.on('did-finish-load', () => {
      ...
      setTimeout(async () => {
        try {
          ...
          // Also pull the conversation feed for this WR (mirrors Phase 3 in
